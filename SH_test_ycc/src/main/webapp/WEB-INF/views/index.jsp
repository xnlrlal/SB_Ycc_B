...
<!-- 슬라이드 배너 -->
	<style>
	/* 슬라이드 배너 이미지 크기 */
		.img_size01 { height: 450px; width: 100%; } /* 슬라이드에 들어가는 이미지 크기 조절*/
	</style>
	...
	<div class="bannergroup">
		<div class="banner_list">
			<ul id="header_navi" style="text-align: center;">
				<li>
					<a href="/ycc/course/courseinfo"><img class="quik_img" src="resources\img\main_img\application_icon.png" alt="수강신청" /><span>강좌신청안내</span></a>
				</li>
				<li>
					<a href="/ycc/rental/place"><img class="quik_img" src="resources\img\main_img\rental_icon.png" alt="대관신청" /><span>대관신청</span></a>
				</li>
				<li>
					<a href="/ycc/club"><img class="quik_img" src="resources\img\main_img\club_icon.png" alt="동아리" /><span>동아리</span></a>
				</li>
				<li>
					<a href="/ycc/rental/locker"><img class="quik_img" src="resources\img\main_img\Locker_icon.png" alt="사물함신청" /><span>사물함신청</span></a>
				</li>
				<li>
					<a href="/ycc/map"><img class="quik_img" src="resources\img\main_img\map_icon.png" alt="찾아오시는 길" /><span>찾아오시는 길</span></a>
				</li>
			</ul>
		</div><!-- // banner_list -->
	</div><!-- // bannergroup -->
